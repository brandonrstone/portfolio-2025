  ...
  return (
    <header className={`fixed top-0 left-0 w-full p-2 z-50 ${textStyleChanges}`}>
      ...
      <div className='max-w-6xl mx-auto flex justify-between items-center p-4 py-5 sm:py-4'>
        <Link href='/' className='text-sm sm:text-lg md:text-lg font-bold transition-colors duration-700 ease-in-out' aria-label='Brandon Stone.dev Home'>Brandon Stone.dev</Link>
